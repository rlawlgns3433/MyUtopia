...
public enum TutorialProgress
{
    ...
    AnimalStat =  44,
    CloseAnimalStat = 47,
    MurgeAnimalPurchase = 49,
    MurgeAnimalConfirm = 51,
    ShowAnimalFocus = 54,
    Murge = 56,
    CloseMurgeAnimalStat = 59,
    MurgeAnimalMove5F = 61,
    MoveAnimal = 62,
    MoveMurgeAnimal = 64,
    CloseAnimalList = 67,
    FloorInfo = 70,
...
public static class WaringTexts
{
    ...
    {
        "재화가 부족합니다.",
        "인구수가 가득 찼습니다. 더이상 동물을 추가할 수 없습니다.",
        "최대 레벨입니다. 더이상 레벨업을 할 수 없습니다.",
        "창고가 가득 찼습니다. 판매 후 재시도 하세요.",
        "리스트가 가득 찼습니다. 판매 후 재시도 하세요.",
        "동물 생성 중입니다.",
        "계층 업그레이드를 위해 모든 건물들의 레벨을 증가시켜야 합니다.",
    };
}
